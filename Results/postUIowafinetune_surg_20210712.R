...
# raw_in = readLines("C:/Users/lauren erdman/Desktop/kidney_img/HN/SickKids/orig_st_results/SickKids_origST_FineTuneUIowa_TrainOnly_40epochs_bs16_lr0.001_RCFalse_covTrue_OSFalse.json")
  ## final layers fine-tune
raw_in = readLines("C:/Users/lauren erdman/Desktop/kidney_img/HN/SickKids/orig_st_results/SickKids_origST_FineTuneFinalLayersUIowa_TrainOnly_40epochs_bs16_lr0.001_RCFalse_covTrue_OSFalse.json")
...
ggplot(st_preds, aes(x = target, y = st_pred_mod_ep1, fill = target)) + geom_violin() + 
  geom_hline(yintercept = dat_thresh_ep1, lwd = 1.2, lty = 2, col = "red") + ylim(0,1) + 
...
saveRDS(st_hn_only, file = "C:/Users/lauren erdman/Desktop/kidney_img/HN/silent_trial/ST_postUIowafinetune_20210818.rds")

### most recent only dataset: 
hn_only_most_recent = get_most_recent(in_dataset = st_hn_only)
head(hn_only_most_recent)
saveRDS(hn_only_most_recent, file = "C:/Users/lauren erdman/Desktop/kidney_img/HN/silent_trial/STmostrecent_postUIowafinetune_20210818.rds")


## overall 
get_sen_spec_withCI(score_vec = st_hn_only$st_pred_mod_ep1, 
                    target = st_hn_only$target01, 
                    threshold = dat_thresh_ep1, 
                    n_it = 500)

## most recent only 
get_sen_spec_withCI(score_vec = hn_only_most_recent$st_pred_mod_ep1, 
...
saveRDS(stan_merge, file = "C:/Users/lauren erdman/OneDrive - SickKids/HN/Stanford/Stanford_postUIowafinetune_20210818.rds")
...
saveRDS(ui_df, file = "C:/Users/lauren erdman/OneDrive - SickKids/HN/UIowa/UI_postUIowatune_20210818.rds")
